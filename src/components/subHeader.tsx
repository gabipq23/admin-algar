        ...
        <div className="flex  justify-between items-center p-2 bg-[#d4d4d4] px-6 md:px-10 lg:px-14">
          <div className="flex items-center gap-8">
            <Dropdown menu={{ items: ordersMenuItems }} placement="bottom">
              <a
                ...
                className={`text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768] ${selectedLink === "pedidos-banda-larga-pf" || selectedLink === "pedidos-banda-larga-pj" || selectedLink === "pedidos-telefonia-movel-pj" || selectedLink === "pedidos-telefonia-movel-pf"
                  ? "font-bold text-[#1a7768]"
                  : ""
                  }`}
              >
                Pedidos
            ...
            <Dropdown menu={{ items: productsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768] ${selectedLink === "produto-banda-larga"
                  ? "font-bold text-[#1a7768]"
                  : ""
                  }`}
              >
            ...
            <Dropdown menu={{ items: clientsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768] ${selectedLink === "clientes-pj" || selectedLink === "clientes-pf"
                  ? "font-bold text-[#1a7768]"
                  : ""
                  }`}
              >
            ...
            <a
              ...
              className={`text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768] ${selectedLink === "contatos" ? "font-bold text-[#1a7768]" : ""
                }`}
            >
              Mensagens
            </a>
            ...
            <Dropdown menu={{ items: chatsMenuItems }} placement="bottom">
              <a className="text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768]">
                Chatter
              </a>
            </Dropdown>
            ...
            <a
              ...
              className={`text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768] ${selectedLink === "book-de-ofertas"
                ? "font-bold text-[#1a7768]"
                : ""
                }`}
            >
            ...
            <Dropdown menu={{ items: toolsMenuItems }} placement="bottom">
              <a
                onClick={(e) => e.preventDefault()}
                className={`text-[14px] cursor-pointer text-[#23917e] hover:text-[#1a7768] ${selectedLink === "pj-checker" ||
                  selectedLink === "check-anatel" ||
                  selectedLink === "zap-checker" ||
                  selectedLink === "base2b-empresa" ||
                  selectedLink === "base2b-socio" ||
                  selectedLink === "check-operadora" || selectedLink === "consulta-disponibilidade"
                  ? "font-bold text-[#1a7768]"
                  : ""
                  }`}
              >
          ...
          <div className="flex items-center gap-4">
            ...
            <Button
              ...
              className="logout-btn "
            >
              <LogoutOutlined style={{ color: "#23917e" }} />
            </Button>
            <style>
              {`
              .subheader-dropdown .ant-dropdown-menu-title-content > a {
                color: #23917e !important;
              }
