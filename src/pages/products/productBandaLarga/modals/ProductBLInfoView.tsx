                                ...
                                <div className="flex flex-wrap items-center gap-2 mt-1">
                                    ...
                                    {planUfs.length > 0 ? (
                                        planUfs.map((uf) => (
                                            <span
                                                key={uf}
                                                className="text-xs font-medium text-[#23917e] bg-blue-50 border border-blue-100 px-2 py-1 rounded"
                                            >
                                                {uf}
                                            </span>
                                        ))
                                    ) : (
                                        <span className="text-xs font-medium text-[#23917e] bg-blue-50 border border-blue-100 px-2 py-1 rounded">
                                            Todas as UFs
                                        </span>
                                    )}
                                </div>
                                        ...
                                        <div className="flex items-start justify-between mb-2">
                                            ...
                                            <div className="flex flex-col gap-1 ml-2 w-14">
                                                {detail.highlight_top && (
                                                    <p className="text-[10px] text-center rounded bg-[#23917e] text-white px-4 py-2">
                                                        Compacto
                                                    </p>
                                                )}
